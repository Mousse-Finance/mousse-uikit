  ...
  return (
    <Svg viewBox="0 0 25 24" {...props}>
      <path
        ...
        fill="#EC6826"
      />
      <path d="M11.45 7.72021H6.44995V9.22022H11.45V7.72021Z" fill="#EC6826" />
      <path d="M18.2 15.75H13.2V17.25H18.2V15.75Z" fill="#EC6826" />
      <path d="M18.2 13.25H13.2V14.75H18.2V13.25Z" fill="#EC6826" />
      <path d="M8.19995 18H9.69995V16H11.7V14.5H9.69995V12.5H8.19995V14.5H6.19995V16H8.19995V18Z" fill="#EC6826" />
      <path
